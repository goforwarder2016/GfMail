 ...
 * Manages core application dependencies without Hilt
 */
class SimpleDependencyContainer(private val context: Context) {
    ...
    private val advancedSecurityManager by lazy { 
        AdvancedSecurityManager(
            context = context,
            credentialEncryption = credentialEncryption,
            securitySettingsUseCase = com.gf.mail.domain.usecase.ManageSecuritySettingsUseCase(settingsRepository)
        )
    }
